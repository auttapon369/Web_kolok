...
{  	
	...
	var marks = url + 'marks.php'+'?dummy='+(new Date()).getTime();
	var html;
	var alert;
	var event;
...
////
	...
	{   
		...
		{         
			...
			var p_rf77 = ( rf == 1 ) ? '<TR><TD CLASS="left" WIDTH="80%">ฝนวันนี้</TD><TD CLASS="right">'+rf_77+'</TD><TD CLASS="left">มม.</TD></TR>' : '';
			var p_rf24 = ( rf == 1 ) ? '<TR><TD CLASS="left" WIDTH="80%">น้ำฝน 24 ชม.</TD><TD CLASS="right">'+rf_24+'</TD><TD CLASS="left">มม.</TD></TR>' : '';
			var p_rf48 = ( rf == 1 ) ? '<TR><TD CLASS="left" WIDTH="80%">น้ำฝน 48 ชม.</TD><TD CLASS="right">'+rf_48+'</TD><TD CLASS="left">มม.</TD></TR>' : '';
			var p_rf72 = ( rf == 1 ) ? '<TR><TD CLASS="left" WIDTH="80%">น้ำฝน 72 ชม.</TD><TD CLASS="right">'+rf_72+'</TD><TD CLASS="left">มม.</TD></TR>' : '';
			...
			html = '<DIV CLASS="popup">'
						...
						+ date + '<BR><BR>'
						+'<TABLE>'
						+ p_rf1 + p_rf77 + p_rf24 + p_rf48 + p_rf72 + p_wl + p_left + p_right + p_lv1 + p_lv2 + p_fl
						+'</TABLE>'
						+ event
					+'</DIV>';
